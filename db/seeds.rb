...
task_one.photo.attach(io: File.open('./app/assets/images/car_wash.png'), filename: 'car_wash.png')
task_two.save!

task = Task.new(name: "Laundry", description: "fold the laundry", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/washing_basket.png'), filename: 'washing_basket.png')
task.save!

task = Task.new(name: "Cleaning", description: "clean the windows", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/window_cleaner.png'), filename: 'window_cleaner.png')
task.save!

task = Task.new(name: "Toilet", description: "clean the toilets", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/toilet.png'), filename: 'toilet.png')
task.save!

task = Task.new(name: "Washing Machine", description: "wash your clothes", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/washing_machine.png'), filename: 'washing_machine.png')
task.save!

task = Task.new(name: "Vacuum", description: "vacuum your room", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/vacuum_cleaner.png'), filename: 'vacuum_cleaner.png')
task.save!
...
task_one.photo.attach(io: File.open('./app/assets/images/trash.png'), filename: 'trash.png')
task.save!

task = Task.new(name: "Laundry", description: "hangs the washing up", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/setting_laundry.png'), filename: 'setting_laundry.png')
task.save!

task = Task.new(name: "Gardening", description: "water the plants", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/water_can.png'), filename: 'water_can.png')
task.save!

task = Task.new(name: "Cleaning", description: "clean the bathroom", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/sink.png'), filename: 'sink.png')
task.save!

task = Task.new(name: "Cleaning", description: "mop the floor", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/mop.png'), filename: 'mop.png')
task.save!

task = Task.new(name: "Cleaning", description: "tidy your house", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/housekeeping.png'), filename: 'housekeeping.png')
task.save!

task = Task.new(name: "Ironning", description: "iron your clothes", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/iron.png'), filename: 'iron.png')
task.save!

task = Task.new(name: "Cleaning", description: "clean your shoes", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/clean_shoes.png'), filename: 'clean_shoes.png')
task.save!

task = Task.new(name: "Cleaning", description: "clean the kitchen", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/cleaning_set.png'), filename: 'cleaning_set.png')
task.save!

task = Task.new(name: "Cleaning", description: "tidy your room", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/cleaning_desk.png'), filename: 'cleaning_desk.png')
task.save!

task = Task.new(name: "Cleaning", description: "clean the house", category: chores)
task_one.photo.attach(io: File.open('./app/assets/images/broom.png'), filename: 'broom.png')
task.save!

puts "Creating grades..."

task = Task.new(name: "History", description: "new grade in history", category: grades)
task_one.photo.attach(io: File.open('./app/assets/images/grade.png'), filename: 'grade.png')
task.save!
...
task_one.photo.attach(io: File.open('./app/assets/images/reading.png'), filename: 'reading.png')
