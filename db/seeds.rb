...
task = Task.new(name: "dishes", description: "wash dishes", points: 300, category: category)
...
achievement = Achievement.new(due_at: "2019-12-01", achieve: false, done: false, user: child, task: task)
